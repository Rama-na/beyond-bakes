...
signature-red-rose-cake.jpg   Three tiers, red garden roses          carousel, filmstrip
garden-floral-cake.jpg        Pressed-flower tiered cake             carousel, filmstrip
floral-event-cake.jpg         Floral celebration, arched plinth      carousel, filmstrip
mousse-cups-florals.jpg       Mousse cups under flowers              filmstrip (flower detail)
...
### The best sellers (the dessert-table menu)
...
plated-tasting.jpg            A composed tasting plate (was in the craft section, since cut)
```
...
3. Reference it from `src/data/bakes.ts`, `src/data/indulgences.ts` or
